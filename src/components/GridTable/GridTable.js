...
export default class GridTable extends Component {
  ...
  /**
   * Accepts 3 Props:
   * 1. data (required): it will be an array of data to be displayed on table body
   ...
   *
   * Currently all the props are passed from a static data.js file in utils folder from App Component.
   * Please refer to App Component for Implementation and data.js for configuration and for format of the data to be passed
   *
